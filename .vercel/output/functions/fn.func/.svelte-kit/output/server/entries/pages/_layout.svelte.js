import { g as get_store_value, c as create_ssr_component, e as escape, a as add_attribute, b as compute_slots, d as subscribe, v as validate_component } from "../../chunks/index2.js";
...
const css = {
  code: ".intersecting.svelte-1hdx5t1{--tw-bg-opacity:1;background-color:rgb(var(--color-primary-500) / var(--tw-bg-opacity));color:rgb(var(--on-primary))\n	}",
  map: null
};
    ...
    header: () => {
      return `${validate_component(AppBar, "AppBar").$$render(
        ...
        {},
        {
          ...
          default: () => {
            return `<div class="w-full flex flex-row justify-center gap-20"><button type="button" class="${[
              "btn btn-lg hover:intersecting svelte-1hdx5t1",
              $intersectionStore.whois ? "intersecting" : ""
            ].join(" ").trim()}"><a href="#Whois">Qui suis-je?</a></button>
				<button type="button" class="${[
              "btn btn-lg bg-initial hover:variant-filled-primary svelte-1hdx5t1",
              $intersectionStore.exp ? "intersecting" : ""
            ].join(" ").trim()}"><a href="#Experience">Expérience</a></button>
				<button type="button" class="${[
              "btn btn-lg bg-initial hover:variant-filled-primary svelte-1hdx5t1",
              $intersectionStore.education ? "intersecting" : ""
            ].join(" ").trim()}"><a href="#Education">Éducation</a></button>
				<button type="button" class="${[
              "btn btn-lg bg-initial hover:variant-filled-primary border-surface-900-50-token svelte-1hdx5t1",
              $intersectionStore.connaissances ? "intersecting" : ""
            ].join(" ").trim()}"><a href="#Connaissances">Connaissances</a></button></div>`;
          }
        }
      )}
	`;
